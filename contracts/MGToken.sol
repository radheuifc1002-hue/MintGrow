...
contract MGToken is ERC20, ERC20Burnable, ERC20Pausable, ERC20Permit, AccessControlDefaultAdminRules {
    bytes32 public constant MINTER_ROLE = keccak256("MG_MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("MG_PAUSER_ROLE");
    bytes32 public constant BLACKLISTER_ROLE = keccak256("MG_BLACKLISTER_ROLE");
