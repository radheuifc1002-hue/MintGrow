    ...
    <LinearGradient colors={['#062A1D', '#0A3B29', '#F4FFF8']} style={[styles.container, { paddingTop: Math.max(insets.top, 4) }]}>
      <View style={styles.content}>
        <View style={styles.topHeader}>
          <View style={styles.brandRow}><BrandMark size={54} /><View><Text style={styles.brand}>MintGrow</Text><Text style={styles.tagline}>BLOCK PUZZLE ARENA</Text></View></View>
          <View style={styles.headerActions}>
            <Pressable onPress={handleMultiplier} disabled={earningMultiplier >= 3 || multiplierLoading} style={[styles.multiplierChip, earningMultiplier > 1 && styles.multiplierChipActive]}>
              <MaterialIcons name="bolt" size={16} color={earningMultiplier > 1 ? '#FFFFFF' : '#0A6B4A'} /><Text style={[styles.multiplierChipText, earningMultiplier > 1 && styles.multiplierChipTextActive]}>{multiplierLoading ? '...' : multiplierText}</Text>
            </Pressable>
            <Pressable onPress={newGame} style={styles.restartButton}><MaterialIcons name="refresh" size={22} color="#063A2A" /><Text style={styles.restartText}>Restart</Text></Pressable>
          </View>
        </View>
...
const progress = StyleSheet.create({ container: { marginHorizontal: 1, marginBottom: 5 }, bar: { height: 5, backgroundColor: '#DCEDE4', borderRadius: 5, overflow: 'hidden' }, fill: { height: '100%', backgroundColor: Colors.primary, borderRadius: 5 }, text: { fontSize: 8, color: '#7C9F90', textAlign: 'center', marginTop: 2, fontWeight: '700' } });
const styles = StyleSheet.create({
  container: { flex: 1, overflow: 'hidden' },
  content: { flex: 1, minHeight: 0, paddingHorizontal: 16, paddingTop: 10, paddingBottom: 5 },
  topHeader: { height: 88, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  brandRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  brand: { fontSize: 30, fontWeight: '900', color: '#FFFFFF', letterSpacing: -0.8 },
  tagline: { fontSize: 11, fontWeight: '800', color: '#B7F7D7', letterSpacing: 1.5, marginTop: 1 },
  headerActions: { alignItems: 'flex-end', gap: 6 },
  restartButton: { height: 44, minWidth: 142, borderRadius: 24, backgroundColor: '#BFF9D9', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 16 },
  restartText: { fontSize: 17, fontWeight: '900', color: '#063A2A' },
  multiplierChip: { height: 27, minWidth: 62, borderRadius: 14, backgroundColor: '#E5FFF0', borderWidth: 1, borderColor: '#B7F1D2', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 3, paddingHorizontal: 8 },
  ...
  arenaCard: { flex: 1, minHeight: 0, backgroundColor: '#F5F8F6', borderRadius: 38, borderWidth: 1, borderColor: '#E5F0EA', paddingHorizontal: 17, paddingTop: 16, paddingBottom: 10, overflow: 'hidden' },
  arenaHeader: { height: 64, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  season: { fontSize: 13, fontWeight: '900', color: Colors.primary, letterSpacing: 1.7 }, title: { fontSize: 26, lineHeight: 29, fontWeight: '900', color: '#073B2B', letterSpacing: -0.6 },
  ...
  scoreStrip: { height: 94, flexDirection: 'row', gap: 10, marginTop: 3, marginBottom: 8 }, boardSection: { flex: 1, minHeight: 0, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
});
